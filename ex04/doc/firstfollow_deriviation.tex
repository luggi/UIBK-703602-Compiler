        ...
        \begin{itemize}
            \item $\First{start}$ derivation\newline
                \begin{tabular}{|l | l |}
                    ...
                    \hline
                    PROGRAM IDENT ';' [ VAR varDecList ] compStmt '.' & add $\First{PROGRAM} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{varDecList}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    IDENT [ ',' IDENT ] ':' type ';' { IDENT [ ',' IDENT ] ':' type ';' } & add $\First{IDENT} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{type}$ derivation\newline
                \begin{tabular}{|l |l |l |}
                    ...
                    \hline
                    [ ARRAY '$[$' NUM '..' NUM '$]$' OF ] simpleType & add $\First{ARRAY}\setminus \epsset$ & add $\left(\First{simpleType} \setminus \epsset\right)$ \\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{simpleType}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    INTEGER & add $\First{INTEGER} \setminus \epsset$\\
                    \hline
                    REAL & add $\First{REAL} \setminus \epsset$\\
                    \hline
                    BOOLEAN & add $\First{BOOLEAN} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{compStmt}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    BEGIN stmtList END & add $\First{BEGIN} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{stmtList}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    statement { ';' statement } & add $\First{statement}$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{statement}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    assignStmt & add $\First{assignStmt} \setminus \epsset$\\
                    \hline
                    compStmt & add $\First{compStmt} \setminus \epsset$\\
                    \hline
                    ifStmt & add $\First{ifStmt} \setminus \epsset$\\
                    \hline
                    whileStmt & add $\First{whileStmt} \setminus \epsset$\\
                    \hline
                    forStmt & add $\First{forStmt} \setminus \epsset$\\
                    \hline
                    READ '$($' exprList '$)$' & add $\First{READ} \setminus \epsset$\\
                    \hline
                    WRITE '$($' exprList '$)$' & add $\First{WRITE} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{assignStmt}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    IDENT [ '$[$' expr '$]$' ] ':=' expr & add $\First{IDENT} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{ifStmt}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    IF expr THEN statement [ ELSE statement ] & add $\First{IF} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{whileStmt}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    WHILE expr DO statement & add $\First{WHILE} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{forStmt}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    FOR IDENT ':=' expr toPart expr DO statement & add $\First{FOR} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{toPart}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    TO & add $\First{TO} \setminus \epsset$\\
                    \hline
                    DOWNTO & add $\First{DOWNTO} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{expr}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    simpleExpr [ relOp simpleExpr ] & add $\First{simpleExpr} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{exprList}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    expr { ',' expr } & add $\First{expr} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{simpleExpr}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    term { addOp term } & add $\First{term} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{term}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    factor { mulOp factor } & add $\First{factor} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{factor}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                    \hline
                    NUM & add $\First{NUM} \setminus \epsset$\\
                    \hline
                    STRING & add $\First{STRING} \setminus \epsset$\\
                    \hline
                    FALSE & add $\First{FALSE} \setminus \epsset$\\
                    \hline
                    TRUE & add $\First{TRUE} \setminus \epsset$\\
                    \hline
                    IDENT [ '$[$' expr '$]$' ] & add $\First{IDENT} \setminus \epsset$\\
                    \hline
                    NOT factor & add $\First{NOT} \setminus \epsset$\\
                    \hline
                    '$-$' factor & add $\First{'$-$'} \setminus \epsset$\\
                    \hline
                    '$($' expr '$)$' & add $\First{'$)$'} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{addOp}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    '$-$' & add $\First{'$-$'} \setminus \epsset$\\
                    \hline
                    OR & add $\First{OR} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
            ...
            \item $\First{mulOp}$ derivation\newline
                \begin{tabular}{|l |l |}
                    ...
                    '$/$' & add $\First{'$/$'} \setminus \epsset$\\
                    \hline
                    DIV & add $\First{DIV} \setminus \epsset$\\
                    \hline
                    MOD & add $\First{MOD} \setminus \epsset$\\
                    \hline
                    AND & add $\First{AND} \setminus \epsset$\\
                    \hline
                \end{tabular}\newline
    ...
    \section{$\Follow{X}$ \textbf{deriviation}}
        \begin{itemize}
            \item $\Follow{start}$ deriviation\newline
                ...
                \textbf{Grammar Rule} & \textbf{Iteration 1}\\
                \hline
                PROGRAM IDENT ';' [ VAR varDecList ] compStmt '.' & \makecell[l]{$\Follow{varDecList} := \First{compStmt} \setminus \epsset = \{BEGIN\}$\\
                                                                                 $\Follow{compStmt} := \{\text{'.'}\}$
                                                                                }\\
                \hline
                IDENT [ ',' IDENT ] ':' type ';' { IDENT [ ',' IDENT ] ':' type ';' } & $\Follow{type} := \{\text{';'}\}$\\
                \hline
                [ ARRAY '$[$' NUM '..' NUM '$]$' OF ] simpleType & $\Follow{simpleType} := \Follow{type}$\\
                \hline
                \end{tabular}
        \end{itemize}
\end{document}
